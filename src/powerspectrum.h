 ...
 ***************************************************************************/
#ifndef _POWERSPECTRUM_H
#define	_POWERSPECTRUM_H

#include "notedetection.h"

namespace noot {

///Frequency refinement algorithm which computes the power spectrum with
///arbitrary frequency resolution
struct PowerSpectrumRefinement : public RefinementAlgorithm {
