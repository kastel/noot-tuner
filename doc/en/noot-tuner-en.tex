...
% Logo and icon are \copyright 2010 Carmen Buonfiglio, licensed under the
...
\begin{itemize}
%\item CPU clock frequency: at least 200 MHz %to be recalculated
...
Version 0.1.1:
\itemize{
	\item Precision is now given in millis, not in cents
	\item Minor improvements to the display
